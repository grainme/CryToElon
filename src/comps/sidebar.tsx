...
export const columns: ColumnDef<Cryptocurrency>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div>
        <img
          src={`${row.original.priceGraph}.png`}
  ...
  },
  {
    ...
    header: "1h %",
    cell: ({ row }) => <div>{row.getValue("change1h").toFixed(2)}%</div>,
  },
  {
    accessorKey: "change24h",
    header: "24h %",
    cell: ({ row }) => <div>{row.getValue("change24h").toFixed(2)}%</div>,
  },
  {
    accessorKey: "change7d",
    header: "7d %",
    cell: ({ row }) => <div>{row.getValue("change7d").toFixed(2)}%</div>,
  },
  {
